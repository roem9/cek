    ...
    class Ft1_model extends CI_MODEL{
        public function kata(){
            $data = [
                // 1-9
                    ...
                    $this->data_kata("392", "Mufrodat 33", "فَـضَّـلَ - يُـفَـضِّـلُ - تَـفْـضِـيْـلاً", "فَضَّلَ-يُفَضِّلُ-تَفْضِيْلاً", "Mengutamakan"),
                    ...
                    $this->data_kata("1217", "Mufrodat 149", "مَاءٌ ج مِيَاهٌ، أَمْوَاهٌ", "مَاءٌ ج مِيَاهٌ", "Air"),
                    $this->data_kata("1218", "Mufrodat 149", "دِيْنٌ ج أَدْيَانٌ", "دِيْنٌ ج أَدْيَانٌ", "Agama"),
                    $this->data_kata("1219", "Mufrodat 149", "عَقْلٌ ج عُقُوْلٌ", "عَقْلٌ ج عُقُوْلٌ", "Akal"),
                    $this->data_kata("1220", "Mufrodat 149", "حَاجِبٌ ج حُجَّابٌ", "حَاجِبٌ ج حُجَّابٌ", "Alis"),
                    $this->data_kata("1221", "Mufrodat 149", "وَلَدٌ ج أَوْلَادٌ", "وَلَدٌ ج أَوْلَادٌ", "Anak (lk)"),
                    $this->data_kata("1222", "Mufrodat 149", "إِبْنٌ ج أَبْنَاءٌ، بَنُوْنَ", "إِبْنٌ ج أَبْنَاءٌ", "Anak (lk)"),
                    $this->data_kata("1223", "Mufrodat 149", "بِنْتٌ ج بَنَاتٌ", "بِنْتٌ ج بَنَاتٌ", "Anak (pr)"),
                    $this->data_kata("1224", "Mufrodat 149", "طِفْلٌ ج أَطْفَالٌ", "طِفْلٌ ج أَطْفَالٌ", "Bayi"),
                    $this->data_kata("1225", "Mufrodat 150", "أَصْلٌ ج أُصُوْلٌ", "أَصْلٌ ج أُصُوْلٌ", "Asal"),
                    $this->data_kata("1226", "Mufrodat 150", "سَقْفٌ ج سُقُوْفٌ", "سَقْفٌ ج سُقُوْفٌ", "Atap"),
                    $this->data_kata("1227", "Mufrodat 150", "قَاعَةٌ ج قَاعَاتٌ", "قَاعَةٌ ج قَاعَاتٌ", "Aula"),
                    $this->data_kata("1228", "Mufrodat 150", "أَبٌ ج آبَاءٌ", "أَبٌ ج آبَاءٌ", "Ayah"),
                    $this->data_kata("1229", "Mufrodat 150", "جُزْءٌ ج أَجْزَاءٌ", "جُزْءٌ ج أَجْزَاءٌ", "Bagian"),
                    $this->data_kata("1230", "Mufrodat 150", "لُغَةٌ ج لُغَاتٌ", "لُغَةٌ ج لُغَاتٌ", "Bahasa"),
                    $this->data_kata("1231", "Mufrodat 150", "ثَوْبٌ ج ثِيَابٌ", "ثَوْبٌ ج ثِيَابٌ", "Baju"),
                    $this->data_kata("1232", "Mufrodat 150", "وِسَادَةٌ ج وَسَائِدُ", "وِسَادَةٌ ج وَسَائِدُ", "Bantal"),
                    $this->data_kata("1233", "Mufrodat 151", "حَجَرٌ ج أَحْجَارٌ", "حَجَرٌ ج أَحْجَارٌ", "Batu"),
                    $this->data_kata("1234", "Mufrodat 151", "شَكْلٌ ج أَشْكَالٌ", "شَكْلٌ ج أَشْكَالٌ", "Bentuk"),
                    $this->data_kata("1235", "Mufrodat 151", "نَجْمٌ ج نُجُوْمٌ", "نَجْمٌ ج نُجُوْمٌ", "Bintang"),
                    $this->data_kata("1236", "Mufrodat 151", "صَبِيٌّ ج صِبْيَانٌ", "صَبِيٌّ ج صِبْيَانٌ", "Anak kecil"),
                    $this->data_kata("1237", "Mufrodat 151", "كُرَةٌ ج كُرَاتٌ", "كُرَةٌ ج كُرَاتٌ", "Bola"),
                    $this->data_kata("1238", "Mufrodat 151", "قَارُوْرَةٌ ج قَوَارِيْرُ", "قَارُوْرَةٌ ج قَوَارِيْرُ", "Botol"),
                    $this->data_kata("1239", "Mufrodat 151", "كِتَابٌ ج كُتُبٌ", "كِتَابٌ ج كُتُبٌ", "Buku"),
                    $this->data_kata("1240", "Mufrodat 151", "دَفْتَرٌ ج دَفَاتِرُ", "دَفْتَرٌ ج دَفَاتِرُ", "Buku tulis"),
                    $this->data_kata("1241", "Mufrodat 152", "شَهْرٌ ج شُهُوْرٌ", "شَهْرٌ ج شُهُوْرٌ", "Bulan"),
                    $this->data_kata("1242", "Mufrodat 152", "قَمَرٌ ج أَقْمَارٌ", "قَمَرٌ ج أَقْمَارٌ", "Rembulan"),
                    $this->data_kata("1243", "Mufrodat 152", "نُوْرٌ ج أَنْوَارٌ", "نُوْرٌ ج أَنْوَارٌ", "Cahaya"),
                    $this->data_kata("1244", "Mufrodat 152", "فِنْجَانٌ ج فَنَاجِيْنُ", "فِنْجَانٌ ج فَنَاجِيْنُ", "Cangkir"),
                    $this->data_kata("1245", "Mufrodat 152", "مِعْزَقٌ ج مَعَازِقُ", "مِعْزَقٌ ج مَعَازِقُ", "Cangkul"),
                    $this->data_kata("1246", "Mufrodat 152", "مِرْآةٌ ج مَرَايَا", "مِرْآةٌ ج مَرَايَا", "Cermin"),
                    $this->data_kata("1247", "Mufrodat 152", "تُبَّانٌ ج تُبَّانَاتٌ، تَبَابِيْنُ", "تُبَّانٌ ج تُبَّانَاتٌ", "Celana dalam"),
                    $this->data_kata("1248", "Mufrodat 152", "بِنْطَالٌ ج بَنَاطِيْلُ", "بِنْطَالٌ ج بَنَاطِيْلُ", "Celana panjang"),
                    $this->data_kata("1249", "Mufrodat 153", "سِرْوَالٌ  ج سَرَاوِيْلُ", "سِرْوَالٌ  ج سَرَاوِيْلُ", "Celana pendek"),
                    $this->data_kata("1250", "Mufrodat 153", "قِصَّةٌ ج قِصَصٌ", "قِصَّةٌ ج قِصَصٌ", "Cerita"),
                    $this->data_kata("1251", "Mufrodat 153", "مِثَالٌ ج أَمْثِلَةٌ", "مِثَالٌ ج أَمْثِلَةٌ", "Contoh"),
                    $this->data_kata("1252", "Mufrodat 153", "مَطْبَخٌ ج مَطَابِخُ", "مَطْبَخٌ ج مَطَابِخُ", "Dapur"),
                    $this->data_kata("1253", "Mufrodat 153", "دَمٌ ج دِمَاءٌ", "دَمٌ ج دِمَاءٌ", "Darah"),
                    $this->data_kata("1254", "Mufrodat 153", "وَرَقٌ ج وَرَقَاتٌ", "وَرَقٌ ج وَرَقَاتٌ", "Daun"),
                    $this->data_kata("1255", "Mufrodat 153", "قَرْيَةٌ ج قُرَى", "قَرْيَةٌ ج قُرَى", "Desa"),
                    $this->data_kata("1256", "Mufrodat 153", "فِلْمٌ ج أَفْلَامٌ", "فِلْمٌ ج أَفْلَامٌ", "Film"),
                    $this->data_kata("1257", "Mufrodat 154", "صُوْرَةٌ ج صُوَرٌ", "صُوْرَةٌ ج صُوَرٌ", "Gambar"),
                    $this->data_kata("1258", "Mufrodat 154", "كُوْبٌ ج أَكْوَابٌ", "كُوْبٌ ج أَكْوَابٌ", "Gelas"),
                    $this->data_kata("1259", "Mufrodat 154", "قُفْلٌ ج أَقْفَالٌ", "قُفْلٌ ج أَقْفَالٌ", "Gembok"),
                    $this->data_kata("1260", "Mufrodat 154", "كَنِيْسَةٌ ج كَنَائِسُ", "كَنِيْسَةٌ ج كَنَائِسُ", "Gereja"),
                    $this->data_kata("1261", "Mufrodat 154", "أُسْتَاذٌ ج أَسَاتِيْذُ", "أُسْتَاذٌ ج أَسَاتِيْذُ", "Guru"),
                    $this->data_kata("1262", "Mufrodat 154", "مِنْشَفَةٌ ج مَنَاشِفُ", "مِنْشَفَةٌ ج مَنَاشِفُ", "Handuk"),
                    $this->data_kata("1263", "Mufrodat 154", "يَوْمٌ ج أَيَّامٌ", "يَوْمٌ ج أَيَّامٌ", "Hari"),
                    $this->data_kata("1264", "Mufrodat 154", "قَلْبٌ ج قُلُوْبٌ", "قَلْبٌ ج قُلُوْبٌ", "Jantung"),
                    $this->data_kata("1265", "Mufrodat 155", "حَيَوَانٌ ج حَيَوَانَاتٌ", "حَيَوَانٌ ج حَيَوَانَاتٌ", "Hewan"),
                    $this->data_kata("1266", "Mufrodat 155", "حَرْفٌ ج حُرُوْفٌ", "حَرْفٌ ج حُرُوْفٌ", "Huruf"),
                    $this->data_kata("1267", "Mufrodat 155", "أُمٌّ ج أُمَّهَاتٌ", "أُمٌّ ج أُمَّهَاتٌ", "Ibu"),
                    $this->data_kata("1268", "Mufrodat 155", "عَاصِمَةٌ ج عَوَاصِمُ", "عَاصِمَةٌ ج عَوَاصِمُ", "Ibu kota"),
                    $this->data_kata("1269", "Mufrodat 155", "إِمَامٌ ج أَئِمَّةٌ", "إِمَامٌ ج أَئِمَّةٌ", "Imam"),
                    $this->data_kata("1270", "Mufrodat 155", "سَمَكٌ ج أَسْمَاكٌ", "سَمَكٌ ج أَسْمَاكٌ", "Ikan"),
                    $this->data_kata("1271", "Mufrodat 155", "قَصْرٌ ج قُصُوْرٌ", "قَصْرٌ ج قُصُوْرٌ", "Istana"),
                    $this->data_kata("1272", "Mufrodat 155", "سَبِيْلٌ ج سُبُلٌ", "سَبِيْلٌ ج سُبُلٌ", "Jalan"),
                    $this->data_kata("1273", "Mufrodat 156", "شَارِعٌ ج شَوَارِعُ", "شَارِعٌ ج شَوَارِعُ", "Jalan raya"),
                    $this->data_kata("1274", "Mufrodat 156", "سَاعَةٌ ج سَاعَاتٌ", "سَاعَةٌ ج سَاعَاتٌ", "Jam"),
                    $this->data_kata("1275", "Mufrodat 156", "خِصَّةٌ ج خِصَصٌ", "خِصَّةٌ ج خِصَصٌ", "Jam pelajaran"),
                    $this->data_kata("1276", "Mufrodat 156", "جَوَابٌ ج أَجْوِبَةٌ", "جَوَابٌ ج أَجْوِبَةٌ", "Jawaban"),
                    $this->data_kata("1277", "Mufrodat 156", "نَافِذَةٌ ج نَوَافِذُ", "نَافِذَةٌ ج نَوَافِذُ", "Jendela"),
                    $this->data_kata("1278", "Mufrodat 156", "جِسْرٌ ج جُسُوْرٌ", "جِسْرٌ ج جُسُوْرٌ", "Jembatan"),
                    $this->data_kata("1279", "Mufrodat 156", "رُوْحٌ ج أَرْوَاحٌ", "رُوْحٌ ج أَرْوَاحٌ", "Ruh"),
                    $this->data_kata("1280", "Mufrodat 156", "مِلْيُوْنٌ ج مَلَايِيْنَ", "مِلْيُوْنٌ ج مَلَايِيْنَ", "Juta"),
                    $this->data_kata("1281", "Mufrodat 157", "قَاعِدَةٌ ج قَوَاعِدُ", "قَاعِدَةٌ ج قَوَاعِدُ", "Kaidah"),
                    $this->data_kata("1282", "Mufrodat 157", "جَدٌّ ج  أَجْدَادٌ", "جَدٌّ ج  أَجْدَادٌ", "Kakek"),
                    $this->data_kata("1283", "Mufrodat 157", "رِجْلٌ ج أَرْجُلٌ", "رِجْلٌ ج أَرْجُلٌ", "Kaki"),
                    $this->data_kata("1284", "Mufrodat 157", "جُمْلَةٌ ج جُمَلٌ", "جُمْلَةٌ ج جُمَلٌ", "Kalimat"),
                    $this->data_kata("1285", "Mufrodat 157", "حُجْرَةٌ ج حُجُرَاتٌ", "حُجْرَةٌ ج حُجُرَاتٌ", "Kamar"),
                    $this->data_kata("1286", "Mufrodat 157", "غُرْفَةٌ ج غُرَفٌ", "غُرْفَةٌ ج غُرَفٌ", "Kamar"),
                    $this->data_kata("1287", "Mufrodat 157", "جَيْبٌ ج جُيُوْبٌ", "جَيْبٌ ج جُيُوْبٌ", "Kantong"),
                    $this->data_kata("1288", "Mufrodat 157", "فِرَاشٌ ج فُرْشٌ", "فِرَاشٌ ج فُرْشٌ", "Kasur"),
                    $this->data_kata("1289", "Mufrodat 158", "فِعْلٌ ج أَفْعَالٌ", "فِعْلٌ ج أَفْعَالٌ", "Tindakan"),
                    $this->data_kata("1290", "Mufrodat 158", "حَالٌ ج أَحْوَالٌ", "حَالٌ ج أَحْوَالٌ", "Keadaan"),
                    $this->data_kata("1291", "Mufrodat 158", "حَدِيْقَةٌ ج حَدَائِقُ", "حَدِيْقَةٌ ج حَدَائِقُ", "Taman"),
                    $this->data_kata("1292", "Mufrodat 158", "مَزِيَّةٌ ج مَزَايَا", "مَزِيَّةٌ ج مَزَايَا", "Keuntungan"),
                    $this->data_kata("1293", "Mufrodat 158", "فَصْلٌ ج فُصُوْلٌ", "فَصْلٌ ج فُصُوْلٌ", "Kelas"),
                    $this->data_kata("1294", "Mufrodat 158", "أُسْرَةُ ج أُسَرٌ", "أُسْرَةُ ج أُسَرٌ", "Keluarga"),
                    $this->data_kata("1295", "Mufrodat 158", "قِرْدٌ ج قُرُوْدٌ", "قِرْدٌ ج قُرُوْدٌ", "Kera"),
                    $this->data_kata("1296", "Mufrodat 158", "قِرْطَاسٌ ج قَرَاطِيْسُ", "قِرْطَاسٌ ج قَرَاطِيْسُ", "Kertas"),
                    $this->data_kata("1297", "Mufrodat 159", "رَئِيْسٌ ج رُؤَسَاءُ", "رَئِيْسٌ ج رُؤَسَاءُ", "Kepala"),
                    $this->data_kata("1298", "Mufrodat 159", "مِرْوَحَةٌ ج مَرَاوِحُ", "مِرْوَحَةٌ ج مَرَاوِحُ", "Kipas angin"),
                    $this->data_kata("1299", "Mufrodat 159", "مَسْبَحٌ ج مَسَابِحُ", "مَسْبَحٌ ج مَسَابِحُ", "Kolam renang"),
                    $this->data_kata("1300", "Mufrodat 159", "صُنْدُوْقٌ ج صَنَادِيْقُ", "صُنْدُوْقٌ ج صَنَادِيْقُ", "Kotak"),
                    $this->data_kata("1301", "Mufrodat 159", "مَدِيْنَةٌ ج مُدُنٌ", "مَدِيْنَةٌ ج مُدُنٌ", "Kota"),
                    $this->data_kata("1302", "Mufrodat 159", "مَقْبَرَةٌ ج مَقَابِرُ", "مَقْبَرَةٌ ج مَقَابِرُ", "Kuburan"),
                    $this->data_kata("1303", "Mufrodat 159", "مِفْتَاحٌ ج مَفَاتِيْحُ", "مِفْتَاحٌ ج مَفَاتِيْحُ", "Kunci"),
                    $this->data_kata("1304", "Mufrodat 159", "ظُفْرٌ ج أَظْفَارٌ", "ظُفْرٌ ج أَظْفَارٌ", "Kuku"),
                    $this->data_kata("1305", "Mufrodat 160", "كُرْسِيٌّ ج كَرَاسِيُ", "كُرْسِيٌّ ج كَرَاسِيُ", "Kursi"),
                    $this->data_kata("1306", "Mufrodat 160", "رَجُلٌ ج رِجَالٌ", "رَجُلٌ ج رِجَالٌ", "Laki-laki"),
                    $this->data_kata("1307", "Mufrodat 160", "مِصْبَاحٌ ج مَصَابِيْحُ", "مِصْبَاحٌ ج مَصَابِيْحُ", "Lampu"),
                    $this->data_kata("1308", "Mufrodat 160", "مَيْدَانٌ ج مَيَادِيْنُ", "مَيْدَانٌ ج مَيَادِيْنُ", "Lapangan"),
                    $this->data_kata("1309", "Mufrodat 160", "بَحْرٌ ج بُحُوْرٌ", "بَحْرٌ ج بُحُوْرٌ", "Laut"),
                    $this->data_kata("1310", "Mufrodat 160", "شَمْعٌ ج شُمُوْعٌ", "شَمْعٌ ج شُمُوْعٌ", "Lilin"),
                    $this->data_kata("1311", "Mufrodat 160", "لِسَانٌ ج أَلْسِنَةٌ", "لِسَانٌ ج أَلْسِنَةٌ", "Lidah"),
                    $this->data_kata("1312", "Mufrodat 160", "مَعْرِفَةٌ ج مَعَارِفُ", "مَعْرِفَةٌ ج مَعَارِفُ", "Pengetahuan"),
                    $this->data_kata("1313", "Mufrodat 161", "نَوْعٌ ج أَنْوَاعٌ", "نَوْعٌ ج أَنْوَاعٌ", "Macam"),
                    $this->data_kata("1314", "Mufrodat 161", "عَسَلٌ ج أَعْسَالٌ", "عَسَلٌ ج أَعْسَالٌ", "Madu"),
                    $this->data_kata("1315", "Mufrodat 161", "مَسْجِدٌ ج مَسَاجِدُ", "مَسْجِدٌ ج مَسَاجِدُ", "Masjid"),
                    $this->data_kata("1316", "Mufrodat 161", "عَيْنٌ ج أَعْيُنٌ، عُيُوْنٌ", "عَيْنٌ ج أَعْيُنٌ", "Mata"),
                    $this->data_kata("1317", "Mufrodat 161", "مَكْتَبٌ ج مَكَاتِبُ", "مَكْتَبٌ ج مَكَاتِبُ", "Kantor"),
                    $this->data_kata("1318", "Mufrodat 161", "دَقِيْقَةٌ ج دَقَائِقُ", "دَقِيْقَةٌ ج دَقَائِقُ", "Menit"),
                    $this->data_kata("1319", "Mufrodat 161", "تِلْمِيْذٌ ج تَلَامِيْذُ", "تِلْمِيْذٌ ج تَلَامِيْذُ", "Murid"),
                    $this->data_kata("1320", "Mufrodat 161", "طَالِبٌ ج طُلَّابٌ", "طَالِبٌ ج طُلَّابٌ", "Siswa"),
                    $this->data_kata("1321", "Mufrodat 162", "مَتْحَفٌ ج مَتَاحِفُ", "مَتْحَفٌ ج مَتَاحِفُ", "Musium"),
                    $this->data_kata("1322", "Mufrodat 162", "نَبِيٌّ ج أَنْبِيَاءُ", "نَبِيٌّ ج أَنْبِيَاءُ", "Nabi"),
                    $this->data_kata("1323", "Mufrodat 162", "اِسْمٌ ج اَسْمَاءٌ", "اِسْمٌ ج اَسْمَاءٌ", "Nama"),
                    $this->data_kata("1324", "Mufrodat 162", "طَبَقٌ ج أَطْبَاقٌ", "طَبَقٌ ج أَطْبَاقٌ", "Nampan"),
                    $this->data_kata("1325", "Mufrodat 162", "بَلَدٌ ج بِلَادٌ", "بَلَدٌ ج بِلَادٌ", "Negara"),
                    $this->data_kata("1326", "Mufrodat 162", "نَصِيْحَةٌ ج نَصَائِحُ", "نَصِيْحَةٌ ج نَصَائِحُ", "Nasihat"),
                    $this->data_kata("1327", "Mufrodat 162", "نَتِيْجَةٌ ج نَتَائِجُ", "نَتِيْجَةٌ ج نَتَائِجُ", "Nilai"),
                    $this->data_kata("1328", "Mufrodat 162", "مَصْنَعٌ ج مَصَانِعُ", "مَصْنَعٌ ج مَصَانِعُ", "Pabrik"),
                    $this->data_kata("1329", "Mufrodat 163", "مَلْبَسٌ ج مَلَابِسُ", "مَلْبَسٌ ج مَلَابِسُ", "Pakaian"),
                    $this->data_kata("1330", "Mufrodat 163", "سُوْقٌ ج أَسْوَاقٌ", "سُوْقٌ ج أَسْوَاقٌ", "Pasar"),
                    $this->data_kata("1331", "Mufrodat 163", "مَنْظَرٌ ج مَنَاظِرُ", "مَنْظَرٌ ج مَنَاظِرُ", "Pemandangan"),
                    $this->data_kata("1332", "Mufrodat 163", "قَلَمٌ ج أَقْلَامٌ", "قَلَمٌ ج أَقْلَامٌ", "Polpen"),
                    $this->data_kata("1333", "Mufrodat 163", "لِصٌّ ج لُصُوْصٌ", "لِصٌّ ج لُصُوْصٌ", "Pencuri"),
                    $this->data_kata("1334", "Mufrodat 163", "رَأْيٌ ج آرَاءٌ", "رَأْيٌ ج آرَاءٌ", "Pendapat"),
                    $this->data_kata("1335", "Mufrodat 163", "سَاكِنٌ ج سُكَّانٌ", "سَاكِنٌ ج سُكَّانٌ", "Penduduk"),
                    $this->data_kata("1336", "Mufrodat 163", "مِسْطَرَةٌ ج مَسَاطِرُ", "مِسْطَرَةٌ ج مَسَاطِرُ", "Penggaris"),
                    $this->data_kata("1337", "Mufrodat 164", "مِمْسَحَةٌ ج مَمَاسِحُ", "مِمْسَحَةٌ ج مَمَاسِحُ", "Penghapus"),
                    $this->data_kata("1338", "Mufrodat 164", "سِجْنٌ ج سُجُوْنٌ", "سِجْنٌ ج سُجُوْنٌ", "Penjara"),
                    $this->data_kata("1339", "Mufrodat 164", "كَاتِبٌ ج كُتَّابٌ،ون،ات", "كَاتِبٌ ج كُتَّابٌ", "Penulis"),
                    $this->data_kata("1340", "Mufrodat 164", "رَاكِبٌ ج رُكَّابٌ", "رَاكِبٌ ج رُكَّابٌ", "Penumpang"),
                    $this->data_kata("1341", "Mufrodat 164", "فَرْقٌ ج فُرُوْقٌ", "فَرْقٌ ج فُرُوْقٌ", "Perbedaan"),
                    $this->data_kata("1342", "Mufrodat 164", "أَمْرٌ ج أَوَامِرُ", "أَمْرٌ ج أَوَامِرُ", "Urusan"),
                    $this->data_kata("1343", "Mufrodat 164", "سُؤَالٌ ج أَسْئِلَةٌ", "سُؤَالٌ ج أَسْئِلَةٌ", "Pertanyaan"),
                    $this->data_kata("1344", "Mufrodat 164", "بَطْنٌ ج بُطُوْنٌ", "بَطْنٌ ج بُطُوْنٌ", "Perut"),
                    $this->data_kata("1345", "Mufrodat 165", "صَحْنٌ ج صُحُوْنٌ", "صَحْنٌ ج صُحُوْنٌ", "Piring"),
                    $this->data_kata("1346", "Mufrodat 165", "شَجَرَةٌ ج أَشْجَارٌ", "شَجَرَةٌ ج أَشْجَارٌ", "Pohon"),
                    $this->data_kata("1347", "Mufrodat 165", "كَوْكَبٌ ج كَوَاكِبُ", "كَوْكَبٌ ج كَوَاكِبُ", "Planet"),
                    $this->data_kata("1348", "Mufrodat 165", "مَعْهَدٌ ج مَعَاهِدُ", "مَعْهَدٌ ج مَعَاهِدُ", "Pondok"),
                    $this->data_kata("1349", "Mufrodat 165", "مَطْعَمٌ ج مَطَاعِمُ", "مَطْعَمٌ ج مَطَاعِمُ", "Restoran"),
                    $this->data_kata("1350", "Mufrodat 165", "أَلْفٌ ج آلَافٍ", "أَلْفٌ ج آلَافٍ", "Ribu"),
                    $this->data_kata("1351", "Mufrodat 165", "بَيْتٌ ج بُيُوْتٌ", "بَيْتٌ ج بُيُوْتٌ", "Rumah"),
                    $this->data_kata("1352", "Mufrodat 165", "صَاحِبٌ ج أَصْحَابٌ", "صَاحِبٌ ج أَصْحَابٌ", "Teman"),
                    $this->data_kata("1353", "Mufrodat 166", "نَعْلٌ ج نِعَالٌ", "نَعْلٌ ج نِعَالٌ", "Sandal"),
                    $this->data_kata("1354", "Mufrodat 166", "أَخٌ ج إِخْوَةٌ، إِخْوَانٌ", "أَخٌ ج إِخْوَةٌ", "Saudara (lk)"),
                    $this->data_kata("1355", "Mufrodat 166", "أُخْتٌ ج أَخَوَاتٌ", "أُخْتٌ ج أَخَوَاتٌ", "Saudara (pr)"),
                    $this->data_kata("1356", "Mufrodat 166", "مَزْرَعَةٌ ج مَزَارِعُ", "مَزْرَعَةٌ ج مَزَارِعُ", "Sawah"),
                    $this->data_kata("1357", "Mufrodat 166", "مَدْرَسَةٌ ج مَدَارِسُ", "مَدْرَسَةٌ ج مَدَارِسُ", "Sekolah"),
                    $this->data_kata("1358", "Mufrodat 166", "مِلْعَقَةٌ ج مَلَاعِقُ", "مِلْعَقَةٌ ج مَلَاعِقُ", "Sendok"),
                    $this->data_kata("1359", "Mufrodat 166", "شَخْصٌ ج أَشْخَاصٌ", "شَخْصٌ ج أَشْخَاصٌ", "Seseorang"),
                    $this->data_kata("1360", "Mufrodat 166", "صِفَةٌ ج صِفَاتٌ", "صِفَةٌ ج صِفَاتٌ", "Sifat"),
                    $this->data_kata("1361", "Mufrodat 167", "مِرْفَقٌ ج مَرَافِقُ", "مِرْفَقٌ ج مَرَافِقُ", "Siku"),
                    $this->data_kata("1362", "Mufrodat 167", "زَوْجٌ ج أَزْوَاجٌ", "زَوْجٌ ج أَزْوَاجٌ", "Pasangan"),
                    $this->data_kata("1363", "Mufrodat 167", "صَوْتٌ ج أَصْوَاتٌ", "صَوْتٌ ج أَصْوَاتٌ", "Suara"),
                    $this->data_kata("1364", "Mufrodat 167", "مَنْبَعٌ ج مَنَابِعُ", "مَنْبَعٌ ج مَنَابِعُ", "Sumber"),
                    $this->data_kata("1365", "Mufrodat 167", "شَرِيْعَةٌ ج شَرَائِعُ", "شَرِيْعَةٌ ج شَرَائِعُ", "Syariat"),
                    $this->data_kata("1366", "Mufrodat 167", "شَرْطٌ ج شُرُوْطٌ", "شَرْطٌ ج شُرُوْطٌ", "Syarat"),
                    $this->data_kata("1367", "Mufrodat 167", "سَنَةٌ ج سَنَوَاتٌ", "سَنَةٌ ج سَنَوَاتٌ", "Tahun"),
                    $this->data_kata("1368", "Mufrodat 167", "رَوْضَةُ ج رِيَاضٌ", "رَوْضَةُ ج رِيَاضٌ", "Taman"),
                    $this->data_kata("1369", "Mufrodat 167", "ضَيْفٌ ج ضُيُوْفٌ", "ضَيْفٌ ج ضُيُوْفٌ", "Tamu"),
                    $this->data_kata("1370", "Mufrodat 168", "يَدٌ ج أَيْدٍ", "يَدٌ ج أَيْدٍ", "Tangan"),
                    $this->data_kata("1371", "Mufrodat 168", "صَدِيْقٌ ج أَصْدِقَاءُ", "صَدِيْقٌ ج أَصْدِقَاءُ", "Teman"),
                    $this->data_kata("1372", "Mufrodat 168", "جِدَارٌ ج جُدُرٌ", "جِدَارٌ ج جُدُرٌ", "Tembok"),
                    $this->data_kata("1373", "Mufrodat 168", "مَلْعَبٌ ج مَلَاعِبُ", "مَلْعَبٌ ج مَلَاعِبُ", "Tempat bermain"),
                    $this->data_kata("1374", "Mufrodat 168", "مَسْكَنٌ ج مَسَاكِنُ", "مَسْكَنٌ ج مَسَاكِنُ", "Tempat tinggal"),
                    $this->data_kata("1375", "Mufrodat 168", "جَارٌ ج جِيْرَانٌ", "جَارٌ ج جِيْرَانٌ", "Tetangga"),
                    $this->data_kata("1376", "Mufrodat 168", "فِرْقَةٌ ج فِرَقٌ", "فِرْقَةٌ ج فِرَقٌ", "Golongan"),
                    $this->data_kata("1377", "Mufrodat 168", "دُكَّانٌ ج دَكَاكِيْنُ", "دُكَّانٌ ج دَكَاكِيْنُ", "Toko"),
                    $this->data_kata("1378", "Mufrodat 169", "هَدَفٌ ج أَهْدَافٌ", "هَدَفٌ ج أَهْدَافٌ", "Tujuan"),
                    $this->data_kata("1379", "Mufrodat 169", "عَظْمٌ ج عِظَامٌ", "عَظْمٌ ج عِظَامٌ", "Tulang"),
                    $this->data_kata("1380", "Mufrodat 169", "أُمَّةٌ ج أُمَمٌ", "أُمَّةٌ ج أُمَمٌ", "Umat"),
                    $this->data_kata("1381", "Mufrodat 169", "جَمَلٌ ج جِمَالٌ", "جَمَلٌ ج جِمَالٌ", "Unta"),
                    $this->data_kata("1382", "Mufrodat 169", "رَسُوْلٌ ج رُسُلٌ", "رَسُوْلٌ ج رُسُلٌ", "Rosul"),
                    $this->data_kata("1383", "Mufrodat 169", "وَجْهٌ ج أَوْجُهٌ، وُجُوْهٌ", "وَجْهٌ ج أَوْجُهٌ", "Wajah"),
                    $this->data_kata("1384", "Mufrodat 169", "نَائِبُ ج نُوَّابٌ", "نَائِبُ ج نُوَّابٌ", "Wakil"),
                    $this->data_kata("1385", "Mufrodat 169", "وَقْتٌ ج أَوْقَاتٌ", "وَقْتٌ ج أَوْقَاتٌ", "Waktu"),
                    $this->data_kata("1386", "Mufrodat 169", "لَوْنٌ ج أَلْوَانٌ", "لَوْنٌ ج أَلْوَانٌ", "Warna"),
                // 
        ...
        public function tema(){
            $data = [
                ...
                $this->data_tema("103", "104", "", "مَوْسِمُ الأَمْطَارِ - فَصْلُ الرَّبِيْعِ", "9", "39"),
