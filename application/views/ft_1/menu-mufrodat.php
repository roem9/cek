                ...
                <?php if(COUNT($mufrodat) != 0):?>
                    <div class="col-12">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item "><a href="#daftarIsi" data-toggle="modal" data-id="Latihan 1|<?= base_url()?>ft_1/mufrodat?latihan=<?= MD5($materi)?>&i=1" class="btn btn-sm btn-block btn-success btn-latihan">Latihan 1</a></li>
                            <li class="list-group-item "><a href="#daftarIsi" data-toggle="modal" data-id="Latihan 2|<?= base_url()?>ft_1/mufrodat?latihan=<?= MD5($materi)?>&i=2" class="btn btn-sm btn-block btn-success btn-latihan">Latihan 2</a></li>
                            <li class="list-group-item "><a href="#daftarIsi" data-toggle="modal" data-id="Latihan 3|<?= base_url()?>ft_1/mufrodat?latihan=<?= MD5($materi)?>&i=3" class="btn btn-sm btn-block btn-success btn-latihan">Latihan 3</a></li>
                        </ul>
                    </div>
