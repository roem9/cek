        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 mb-3">
                    <img src="<?= base_url()?>assets/img/ft_2/<?= str_replace("Mufrodat ", "", $materi)?>.jpg" class="img-rounded img-fluid" alt="Cinque Terre">
                </div>
                <?php if(COUNT($mufrodat) != 0):?>
                    <div class="col-12">
                        <ul class="list-group">
                            <li class="list-group-item list-group-item-warning">Latihan</li>
                            <li class="list-group-item "><a href="#daftarIsi" data-toggle="modal" data-id="Latihan 1|<?= base_url()?>ft_2/mufrodat?latihan=<?= MD5($materi)?>&i=1" class="btn btn-sm btn-block btn-success btn-latihan">Latihan 1</a></li>
                            <li class="list-group-item "><a href="#daftarIsi" data-toggle="modal" data-id="Latihan 2|<?= base_url()?>ft_2/mufrodat?latihan=<?= MD5($materi)?>&i=2" class="btn btn-sm btn-block btn-success btn-latihan">Latihan 2</a></li>
                            <li class="list-group-item "><a href="#daftarIsi" data-toggle="modal" data-id="Latihan 3|<?= base_url()?>ft_2/mufrodat?latihan=<?= MD5($materi)?>&i=3" class="btn btn-sm btn-block btn-success btn-latihan">Latihan 3</a></li>
                        </ul>
                    </div>
